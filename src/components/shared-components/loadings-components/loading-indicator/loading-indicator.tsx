...
import { LayoutWarperLazy } from "@/components/layouts-components/panel-layout/layout-lazy";
import AppLoading from "../app-loading/loading";
...
export function LoadingIndicator({
  ...
  return (
    <div className="h-full w-full flex flex-col overflow-hidden">
      ...
      <Suspense fallback={<InitLoadingPage />}>{wrappedComponent}</Suspense>
    </div>
  );
}
