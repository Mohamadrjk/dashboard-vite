...
const CategoriesSoldInPeriodOfTime = () => {
  const {
    isError,
    items,
    loading,
  ...
  const chartOptions: ApexOptions = useMemo(() => {
    return {
      ...
      yaxis: [
        {
          title: {
            text: "مجموع تعداد فروش", // Sales Axis Label
          },
          labels: {
      ...
      tooltip: {
        ...
        <div style="background: #002140;color:white; padding: 10px; border: 1px solid #ccc; border-radius: 5px;font-family:'Medium';direction:rtl">
          ...
          <p style="margin: 0;">
            <span>تعد فروش:</span> ${numberToPersianPrice(sales * 10)} تومان
          </p>
          <p style="margin: 0;">
...
export default CategoriesSoldInPeriodOfTime;
